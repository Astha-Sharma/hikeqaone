						...
						<div className="row">
							<div className="col col-lg-3">
								<div className="form-group">
									...
									<DefaultDatepicker onChange={(e) => this._onChangeDefaultDate(e)}/>
					...
					<Widget
						...
						<div className="row">
							<div className="col col-lg-6">
								<ConnectedDatePicker onChangeFrom={(e) => this._onChangeDateFrom(e)} onChangeTo={(e) => this._onChangeDateTo(e)} dateFrom={this.state.dateFrom} dateTo={this.state.dateTo} />
							</div>
						</div>
					</Widget>
					<Widget
							...
							<div className="col col-lg-3">
								<InlineDatepicker onChange={(e) => this._onChangeInlineDate(e)}/>
									{this.state.inlineDate && 
										<p className="m-t-50">Selected date: {this.state.inlineDate}</p>
									}
							</div>
						</div>
					</Widget>
