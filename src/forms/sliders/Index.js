...
class Sliders extends React.Component {
	...
	constructor() {
		...
		this.onChangeRangeSliderWithTooltip = this.onChangeRangeSliderWithTooltip.bind(this)
		this.state = {
			defaultSlider: 40,
			rangeSlider: [30,70],
	...
	render() {
		return (
			<div className="row">
				<div className="col">
					<Widget title="Simple sliders" description="Use the following examples as a starting point for your custom sliders">
						<p>{"Value: "} {this.state.defaultSlider}</p>
						<DefaultSlider
						...
						/>
						<br />
						<p>{"Value: "} {this.state.rangeSlider[0]}{"-"}{this.state.rangeSlider[1]}</p>
						<RangeSlider
					...
					<Widget title="Sliders with tooltips" description="Use the following examples as a starting point for sliders with tooltips">
						<p>{"Value: "} {this.state.sliderWithTooltip}</p>
						<SliderWithTooltip
						...
						/>
						<br />
						<p>{"Value: "} {this.state.rangeSliderWithTooltip[0]}{"-"}{this.state.rangeSliderWithTooltip[1]}</p>
