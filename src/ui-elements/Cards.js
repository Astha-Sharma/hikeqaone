                ...
                <div className="card card-with-badge">
                  ...
                  <div className="card-block">
                    ...
                    <p className="card-actions">
                      <span>Like</span><i className="fa fa-thumbs-o-up" />
                      <span>Comment</span><i className="fa fa-comment" />
                    </p>
                  </div>
                </div>
                <div className="card">
                  ...
                  <div className="card-block">
                    ...
                    <p className="card-actions">
                      <span>Reply</span><i className="fa fa-mail-reply" />
                    </p>
                  </div>
                </div>
                <div className="card">
                ...
                <div className="card card-with-badge">
                  ...
                  <div className="card-block">
                    ...
                    <p className="card-actions m-b-10">
                      <span>10</span><i className="fa fa-star-o" />
                      <span>23</span><i className="fa fa-heart-o" />
                    </p>
